...
with col1:
    stocks_list = st.multiselect("Choose 4 stocks",('TSAL','AAPL','NFLX','MSFT','MGM','AMZN','NVDA','GOOGL'),['TSAL','AAPL','AMZN','GOOGL'])
with col2:
...
try:
    ...
    with col1:
        ...
        st.write(stocks_df.head(),use_container_width = True)
    with col2:
        st.markdown("### Dataframe tail")
        st.write(stocks_df.tail(),use_container_width = True)   
